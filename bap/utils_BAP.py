# Source: https://github.com/Open-EO/openeo-community-examples/blob/main/python/RankComposites/utils_BAP.py
...
def calculate_cloud_coverage_score(
    cloud_mask: openeo.DataCube, area: dict, scl: openeo.DataCube
) -> openeo.DataCube:
    """
...
def calculate_distance_to_cloud_score(
    binary: openeo.DataCube, spatial_resolution: int, max_distance: Optional[int] = 150
) -> openeo.DataCube:
    """
...
def aggregate_BAP_scores(
    dtc_score: openeo.DataCube,
