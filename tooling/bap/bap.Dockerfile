...
# metadata
ARG SOLUTION="PEOPLE-ECCO Best Available Pixel"
...
LABEL org.opencontainers.image.title=${SOLUTION} \
      ...
      org.opencontainers.image.source="https://github.com/PEOPLE-ECCO/best-available-pixel" \
...
COPY tooling/bap/requirements.txt requirements.txt
